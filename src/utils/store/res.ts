...
export type ResState = Record<string, ResItemState>;
...
const resSlice = createSlice({
	...
	reducers: {
		...
		updateDataItem(
			...
			const resState = state[res] || ({} as ResItemState);
...
export const { clearCache, updateData, updateDataItem } = resSlice.actions;
